<?php
		require_once("phar://../com.phar/phpSDK.phar/com.qys.service.impl/RemoteSignServiceImpl.php");
...
//		$a1 = get_millistime();
//		$post_data = array(
//		    "subject" => "xushuaiRemote文件创建",
//		    "expireTime" => "2017-07-08",
//		    "docName" => "languageRemote",
...
//		print_r("**************".$a3);
	...
	/*	$templates = array(
		...
		//***********************************************************************1.3 由html创建
	/*	$post_data = array(
		    "subject" => "222remote-PHP-Html",
		    "expireTime" => "2017-07-08",
		    "docName" => "222remotehtmlphplanguage2",
			"html" => "<html><body><p>title</p><p>xushuai在线第三方电子合同平台。企业及个人用户可通过本平台与签约方快速完成合同签署，安全、合法、有效。</p></body></html>"
		);
		...
		*/
        ...
        $post_data = array(
            "documentId" => "2312793903439847826",
            "visible" => true,//带签名外观
...
(
    ...
    [message] => SUCCESS
		...
		$post_data = array(
		    "documentId" => "2307494535160820395",
			"operation" => "SIGN",
		...
		//***********************************************************************6.2 获取查看合同页面的链接
/*		$post_data = array(
		    "documentId" => "2312209302023610988"
		);
